defmodule Protobuf.DecoderTest do
  ...
  test "Protobuf.Decoder.decode(00001000_10010110_00000001) returns {:ok, %{1 => <<2, 22::size(6)>>}}" do
    assert {:ok, %{1 => <<2, 22::size(6)>>}} = Decoder.decode(~b(00001000_10010110_00000001))
  end
end
